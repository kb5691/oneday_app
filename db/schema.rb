...
ActiveRecord::Schema.define(version: 20_220_925_013_726) do
  ...
  create_table "post_valuations", force: :cascade do |t|
    t.bigint "post_id", null: false
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["post_id"], name: "index_post_valuations_on_post_id"
  end
  ...
  add_foreign_key "post_valuations", "posts"
